# Project 2 - *FlixterApplication*

**FlixterApplication** shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
<img src='flixterappgif.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
